...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2024 at 05:29 AM
...
(18, 'CRASH WORLD TOUR in Kuala Lumpur', 'Kehlani', '2025-02-21', '20:00:00', 'Merdeka Hall, World Trade Center', 'The Kehlani Crash Tour is an electrifying concert series bringing unforgettable performances, explosive energy, and iconic music to fans worldwide. Get ready to crash the stage with Kehlani’s hottest hits and unforgettable live vibes! 🎶✨', '<h3>ONSALE DETAILS</h3>\r\n\r\n<p><strong>Artist Presale</strong><br />\r\n📆 25 Nov (Monday)<br />\r\n⏰ 11 AM - 11:59 PM<br />\r\n<em>Visit </em><a href=\"https://www.kehlani.com/\" target=\"_blank\"><strong><em>kehlani.com</em></strong></a><em> for more details</em></p>\r\n\r\n<p><strong>Live Nation Presale</strong><br />\r\n📆 26 Nov (Tuesday)<br />\r\n⏰ 11 AM - 11:59 PM<br />\r\n<em>Register for a FREE membership via </em><a href=\"https://www.livenation.my/\" target=\"_blank\"><strong><em>www.livenation.my</em></strong></a><em> to access the presale!⁠</em></p>\r\n\r\n<p><strong>General Onsale</strong><br />\r\n📆 27 Nov (Wednesday)<br />\r\n⏰ 10 AM onwards</p>\r\n\r\n<hr />\r\n<h3>ABOUT KEHLANI</h3>\r\n\r\n<p>Kehlani will open your eyes, open your mind, and open your heart. For as blunt as Kehlani may be about life, longing, lust, and love, Kehlani&rsquo;s music occupies an elevated state above even the best high -- yet accessible by simply listening. The Bay Area-born two-time GRAMMY Award-nominated multi-platinum songstress unlocks this place anytime she picks up a pen or grabs a microphone.</p>\r\n\r\n<p>Since 2014, Kehlani&rsquo;s light has only continued to glow brighter. Thus far, Kehlani has picked up over twenty gold and platinum RIAA certifications, tallied 9 billion streams, and garnered a pair of GRAMMY Award nominations in the categories of &quot;Best Urban Contemporary Album&#39;&#39; for the gold-certified mixtape You Should Be Here and &quot;Best R&amp;B Performance&quot; for the platinum single &quot;Distraction.&quot;</p>\r\n\r\n<p>Beyond blockbuster collaborations with Cardi B, Justin Bieber, Post Malone, Kiana Led&eacute;, Teyana Taylor, and Kyle, Kehlani has appeared on soundtracks such as Suicide Squad: The Album, The Fate of the Furious: The Album, and more. Along the way, the singer received the &quot;Rule Breaker Award&#39;&#39; from Billboard Women In Music and performed at Voodoo Music + More, Coachella, and beyond.</p>\r\n', 0x75706c6f6164732f6b65686c616e692e6a7067, 0x75706c6f6164732f6b65686c616e69736561742e6a7067, 0);
...
(24, 'Ali', 'ali@gmail.com', '  hii, unregistered user ', 'Replied through Email', 0),
(25, 'Adelia Feya', 'adelia@gmail.com', '  hiii, im internal user', '  GAGGAGAADD', 1),
(26, 'Thrisha Yusri', 'thrisha@gmail.com', '  dgdgdgdgdggd', '', 1),
(27, 'azlin', 'azlin@gmail.com', '  hiiiii, ni umi', 'Replied through Email', 0),
(28, 'Aedris  Falique', 'aedries@gmail.com', '  hii, can i ask you a.......', '  hii, carat team....', 1),
(29, 'Fiezah', 'fiezah@gmail.com', '  hii, is it possible to buy a ticket without registering....', 'Replied through Email', 0);
...
(25, 'Thrisha', 'Yusri', 'thrisha@gmail.com', '0122845545', 'Ampang', 5, 16, 3, 2910, 'FPX Payment', 13),
(26, 'Adelia', 'Feya', 'adelia@gmail.com', '1234567', 'Ampang, Selangor', 5, 16, 2, 1940, 'FPX Payment', 15),
(27, 'Thrisha', 'Yusri', 'thrisha@gmail.com', '0122845545', 'Ampang, Selangor', 5, 15, 2, 2940, 'FPX Payment', 13),
(28, 'Thrisha', 'Yusri', 'thrisha@gmail.com', '0122845545', 'Ampang, Selangor', 5, 16, 3, 2910, 'FPX Payment', 13),
(29, 'Aedris ', 'Falique', 'aedries@gmail.com', '0173546282', 'Cheras', 5, 15, 2, 2940, 'FPX Payment', 16);
...
(15, 'Soundcheck ', 1450, 100, 'Standing Zone', 5, 94, 0),
(16, 'Limbo VIP ', 950, 100, 'Standing Zone', 5, 17, 0),
...
(45, 'KEHLANI VIP M&G PACKAGE', 1348, 70, 'Standing Zone', 18, 70, 0),
(46, 'CAT 1', 988, 100, '102', 6, 100, 0),
(47, 'CAT 1', 988, 100, '101', 6, 100, 0),
(48, 'CAT 1', 988, 50, '116', 6, 50, 0),
(49, 'CAT 2', 698, 20, '201', 6, 20, 0),
(50, 'CAT 2', 698, 3, '103', 6, 3, 0),
(51, 'CAT 3', 598, 0, '105', 6, 0, 0),
(52, 'CAT 4 ', 498, 1, 'Standing Zone', 6, 1, 0),
(53, 'CAT 5', 498, 2, '108', 6, 2, 0),
(54, 'CAT 6 ', 398, 28, '114', 6, 28, 0),
(55, 'CAT 7', 298, 5, '208', 6, 5, 0),
(56, 'CAT 2', 988, 200, '114', 10, 200, 0),
(57, 'CAT 1', 1288, 100, '115', 10, 100, 0),
(58, 'CAT 6', 498, 0, '210', 10, 0, 0),
(59, 'BOX', 1488, 40, 'BOX', 14, 40, 0);
...
(13, 'Thrisha', 'Yusri', 'thrisha@gmail.com', 'thrisha', '2024-11-03', 122845545, 'Ampang, Selangor'),
(15, 'Adelia', 'Feya', 'adelia@gmail.com', 'adelia', '2024-11-22', 122845545, 'Amapang Taman Melur'),
(16, 'Aedris ', 'Falique', 'aedries@gmail.com', 'aedris', '2024-11-27', 173546282, 'Cheras');
